        ...
        try {
            ...
            $sale = Sale::create(
                [
                    ...
                    'product_old_price_sale' => round($data[6] ?? $data[4]),
                    'product_price_sale' => round($productPriceSale),
                    'product_qty_sale' => 1,
                    'status_sale' => 'proses',
                    'status_product' => $data[10] ?? $data[6],
                    'total_discount_sale' => round($totalDiscountSale), 
                    'new_discount_sale' => round($newDiscountSale),
                    'display_price' => round($displayPrice), 
