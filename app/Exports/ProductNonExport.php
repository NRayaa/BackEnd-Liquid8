...
class ProductNonExport implements FromQuery, WithHeadings, WithMapping, WithChunkReading
{
    use Exportable;
    ...
    {
        return New_product::whereNotNull('new_quality->non')->whereNull('is_so')->whereNotIn('new_status_product', ['migrate', 'sale'])
            ->select(
                'code_document',
                'old_barcode_product',
                'new_barcode_product',
